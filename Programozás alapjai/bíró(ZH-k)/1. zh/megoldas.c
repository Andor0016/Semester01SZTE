...
Keszits egy programot, amely kiirja a ``Lima'' szoveget a kepernyore
...
szamot, majd a masodik es elso szam kulonbseget (masodik minusz elso)
kiirja a kepernyore! A kiiratast sorvege jel zarja! A program mast ne
irjon ki!
