...
*/
int bentvan(char oszlop, char sor){
...
int huszar(char oszlop, char sor) {
    int x = 0;
    if(oszlop>='c' && oszlop<='f' && sor >= '3' && sor <='6')
    {
        x=8;
    }
    else
    {
        x = bentvan(oszlop+2, sor+1) + bentvan(oszlop+2, sor-1)
                + bentvan(oszlop-2, sor+1) + bentvan(oszlop-2, sor-1)
                + bentvan(oszlop+1, sor+2) + bentvan(oszlop-1, sor+2)
                + bentvan(oszlop+1, sor-2) + bentvan(oszlop-1, sor-2);
    }
    return x;
}
